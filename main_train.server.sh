...
# One image we saw small, now large
python main_train.py --input_name nature5.jpg --input_dir Input/Images --mask_coords "(1245,1875),(1495,2080)" --norm 0 --min_size 150 --max_size 1500
...
python main_train.py --input_name western_wall.jpg --input_dir Input/Images --mask_coords (370,630),(480,600) --norm 0 --min_size 60 --max_size 600
python main_train.py --input_name windows.jpg      --input_dir Input/Images --mask_coords (200,280),(700,760) --norm 0
python main_train.py --input_name windows.jpg      --input_dir Input/Images --mask_coords (200,280),(700,760) --norm 0 --min_size 60 --max_size 600
python main_train.py --input_name woman_bricks.jpg --input_dir Input/Images --mask_coords (1050,3200),(2600,3500) --norm 0
python main_train.py --input_name woman_bricks.jpg --input_dir Input/Images --mask_coords (1050,3200),(2600,3500) --norm 0 --min_size 150 --max_size 1500
