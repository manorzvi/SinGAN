...
python main_train.py --input_name balloons_tent.png         --input_dir Input/Images --mask_coords "(0,70),(130,180)" --norm 1
...
python main_train.py --input_name balloons_yellow.png         --input_dir Input/Images --mask_coords "(100,125),(100,125)" --norm 1 --min_size 50  --max_size 500

echo "[I] - balloons_yellow random sampling start scale 0"
echo "------------------------------------------"
python random_samples.py --input_name balloons_yellow.png          --model_dir TrainedModels/balloons_yellow/scale_factor\=0.750000\,alpha\=10\,min_size\=50\,max_size\=500/          --mode random_samples --gen_start_scale 0 --min_size 50 --max_size 500 &
echo "[I] - balloons_yellow random sampling start scale 1"
echo "------------------------------------------"
python random_samples.py --input_name balloons_yellow.png          --model_dir TrainedModels/balloons_yellow/scale_factor\=0.750000\,alpha\=10\,min_size\=50\,max_size\=500/          --mode random_samples --gen_start_scale 1 --min_size 50 --max_size 500 &

python main_train.py --input_name balloons_color.png         --input_dir Input/Images --mask_coords "(0,70),(130,180)" --norm 1 --min_size 50  --max_size 500

echo "[I] - balloons_color random sampling start scale 0"
echo "------------------------------------------"
python random_samples.py --input_name balloons_color.png          --model_dir TrainedModels/balloons_color/scale_factor\=0.750000\,alpha\=10\,min_size\=50\,max_size\=500/          --mode random_samples --gen_start_scale 0 --min_size 50 --max_size 500 &
echo "[I] - balloons_color random sampling start scale 1"
echo "------------------------------------------"
python random_samples.py --input_name balloons_color.png          --model_dir TrainedModels/balloons_color/scale_factor\=0.750000\,alpha\=10\,min_size\=50\,max_size\=500/          --mode random_samples --gen_start_scale 1 --min_size 50 --max_size 500 &

python main_train.py --input_name balloons_tent.png         --input_dir Input/Images --mask_coords "(0,70),(130,180)" --norm 1 --min_size 50  --max_size 500

echo "[I] - balloons_tent random sampling start scale 0"
echo "------------------------------------------"
python random_samples.py --input_name balloons_tent.png          --model_dir TrainedModels/balloons_tent/scale_factor\=0.750000\,alpha\=10\,min_size\=50\,max_size\=500/          --mode random_samples --gen_start_scale 0 --min_size 50 --max_size 500 &
echo "[I] - balloons_tent random sampling start scale 1"
echo "------------------------------------------"
python random_samples.py --input_name balloons_tent.png          --model_dir TrainedModels/balloons_tent/scale_factor\=0.750000\,alpha\=10\,min_size\=50\,max_size\=500/          --mode random_samples --gen_start_scale 1 --min_size 50 --max_size 500 &


#python main_train.py --input_name western_wall.jpg    --input_dir Input/Images --mask_coords "(370,630),(480,600)"     --norm 1 --min_size 50  --max_size 500
...
#python main_train.py --input_name windows.jpg         --input_dir Input/Images --mask_coords "(200,280),(700,760)"     --norm 1 --min_size 50  --max_size 500
...
#python main_train.py --input_name woman_bricks.jpg    --input_dir Input/Images --mask_coords "(1050,3200),(2600,3500)" --norm 1 --min_size 50 --max_size 500
...
#python main_train.py --input_name climb1.jpg          --input_dir Input/Images --mask_coords "(120,290),(800,870)"     --norm 1 --min_size 50 --max_size 500
...
#python main_train.py --input_name nature5.jpg         --input_dir Input/Images --mask_coords "(1245,1875),(1495,2080)" --norm 1 --min_size 50 --max_size 500
